...
-- MJ 
ops.go(ops.mjoin_ra('a=country_deathToConfirmed_ratio','b=death_confirmed_pair','country,arbdate','country,new_Date','country,arbdate,deathToConfirmedRatio','final_confirmeddeath_ration')); 
