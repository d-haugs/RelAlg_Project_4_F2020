...
ops.mjoin_ra('a=RAW_global_deaths','b=RAW_global_deaths','country,province','country,province','a.country,a.province,a.date,b.date,a.count,b.count','raw_global_death_pair')); 
